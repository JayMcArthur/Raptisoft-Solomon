...
# virtual methods
.method public final a(Ljava/lang/String;Ljava/lang/String;I)Ld/b/b/a/i/km;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-instance p2, Ld/b/b/a/i/Bm;

    invoke-direct {p2}, Ld/b/b/a/i/Bm;-><init>()V
    ...
    :cond_4
    new-instance p2, Ld/b/b/a/i/zm;

    invoke-direct {p2}, Ld/b/b/a/i/zm;-><init>()V

    goto :goto_3

    :cond_5
    new-instance p2, Ld/b/b/a/i/ym;

    invoke-direct {p2}, Ld/b/b/a/i/ym;-><init>()V

    goto :goto_3

    :cond_6
    new-instance p2, Ld/b/b/a/i/xm;

    invoke-direct {p2}, Ld/b/b/a/i/xm;-><init>()V

    goto :goto_3

    :cond_7
    new-instance p2, Ld/b/b/a/i/wm;

    invoke-direct {p2}, Ld/b/b/a/i/wm;-><init>()V

    goto :goto_3

    :cond_8
    new-instance p2, Ld/b/b/a/i/um;

    invoke-direct {p2}, Ld/b/b/a/i/um;-><init>()V

    :goto_3
    invoke-interface {p2}, Ld/b/b/a/i/km;->getVersion()I
